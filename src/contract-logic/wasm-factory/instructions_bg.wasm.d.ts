...
export function getCycleStatePubkeyWasm(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function getMasterMintPubkeyWasm(a: number, b: number, c: number): void
export function getMasterMetadataPubkeyWasm(a: number, b: number, c: number): void
export function getTokenMintPubkeyWasm(a: number, b: number, c: number): void
