...
function __wbg_adapter_32(arg0, arg1, arg2) {
  _assertNum(arg0)
  _assertNum(arg1)
  wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2da01f653f47e4c0(
    arg0,
    arg1,
    addHeapObject(arg2)
  )
...
function __wbg_adapter_142(arg0, arg1, arg2, arg3) {
  _assertNum(arg0)
  _assertNum(arg1)
  wasm.wasm_bindgen__convert__closures__invoke2_mut__hb3f15742028586c9(
    arg0,
    arg1,
    addHeapObject(arg2),
    addHeapObject(arg3)
 ...
 *
 * An instruction specifies which program it is calling, which accounts it may read or modify, and
 * additional data that serves as input to the program. One or more instructions are included in
 * transactions submitted by Solana clients. Instructions are also used to describe cross-program
 * invocations.
 *
 * During execution, a program will receive a list of account data as one of its arguments, in the
 * same order as specified during `Instruction` construction.
 *
 * While Solana is agnostic to the format of the instruction data, it has built-in support for
 * serialization via `borsh` and `bincode`.
 *
 * # Specifying account metadata
 *
 * When constructing an [`Instruction`], a list of all accounts that may be read or written during
 * the execution of that instruction must be supplied as [`AccountMeta`] values.
 *
 * Any account whose data may be mutated by the program during execution must be specified as
 * writable. During execution, writing to an account that was not specified as writable will cause
 * the transaction to fail. Writing to an account that is not owned by the program will cause the
 * transaction to fail.
 *
 * Any account whose lamport balance may be mutated by the program during execution must be
 * specified as writable. During execution, mutating the lamports of an account that was not
 * specified as writable will cause the transaction to fail. While *subtracting* lamports from an
 * account not owned by the program will cause the transaction to fail, *adding* lamports to any
 * account is allowed, as long is it is mutable.
 *
 * Accounts that are not read or written by the program may still be specified in an `Instruction`'s
 * account list. These will affect scheduling of program execution by the runtime, but will
 * otherwise be ignored.
 *
 * When building a transaction, the Solana runtime coalesces all accounts used by all instructions
 * in that transaction, along with accounts and permissions required by the runtime, into a single
 * account list. Some accounts and account permissions required by the runtime to process a
 * transaction are *not* required to be included in an `Instruction`s account list. These include:
 *
 * - The program ID — it is a separate field of `Instruction`
 * - The transaction's fee-paying account — it is added during `Message` construction. A program may
 *   still require the fee payer as part of the account list if it directly references it.
 *
 * Programs may require signatures from some accounts, in which case they should be specified as
 * signers during `Instruction` construction. The program must still validate during execution that
...
export class SystemInstruction {
  ...
  static createAccount(from_pubkey, to_pubkey, lamports, space, owner) {
    ...
    var ret = wasm.systeminstruction_createAccount(
      from_pubkey.ptr,
      to_pubkey.ptr,
      low0,
      high0,
  ...
  static createAccountWithSeed(from_pubkey, to_pubkey, base, seed, lamports, space, owner) {
    ...
    var ret = wasm.systeminstruction_createAccountWithSeed(
      from_pubkey.ptr,
      to_pubkey.ptr,
      base.ptr,
      ptr0,
  ...
  static transferWithSeed(from_pubkey, from_base, from_seed, from_owner, to_pubkey, lamports) {
    ...
    const low1 = u32CvtShim[0]
    const high1 = u32CvtShim[1]
    var ret = wasm.systeminstruction_transferWithSeed(
      from_pubkey.ptr,
      from_base.ptr,
      ptr0,
      len0,
  ...
  static allocateWithSeed(address, base, seed, space, owner) {
    ...
    var ret = wasm.systeminstruction_allocateWithSeed(
      address.ptr,
      base.ptr,
      ptr0,
      len0,
  ...
  static createNonceAccount(from_pubkey, nonce_pubkey, authority, lamports) {
    ...
    const low0 = u32CvtShim[0]
    const high0 = u32CvtShim[1]
    var ret = wasm.systeminstruction_createNonceAccount(
      from_pubkey.ptr,
      nonce_pubkey.ptr,
      authority.ptr,
      low0,
  ...
  static withdrawNonceAccount(nonce_pubkey, authorized_pubkey, to_pubkey, lamports) {
    ...
    const low0 = u32CvtShim[0]
    const high0 = u32CvtShim[1]
    var ret = wasm.systeminstruction_withdrawNonceAccount(
      nonce_pubkey.ptr,
  ...
  static authorizeNonceAccount(nonce_pubkey, authorized_pubkey, new_authority) {
    ...
    var ret = wasm.systeminstruction_authorizeNonceAccount(
      nonce_pubkey.ptr,
      authorized_pubkey.ptr,
      new_authority.ptr
    )
...
export function __wbg_fetch_fb26f738d9707b16() {
...
export function __wbg_instruction_new() {
  return logError(function (arg0) {
...
export function __wbg_pubkey_new() {
  return logError(function (arg0) {
...
export function __wbg_debug_675b0ecb65722d2a() {
  return logError(function (arg0) {
    console.debug(getObject(arg0))
  }, arguments)
}

export function __wbg_error_cc38ce2b4b661e1d() {
  return logError(function (arg0) {
    console.error(getObject(arg0))
  }, arguments)
}

export function __wbg_info_e0c9813e6fd3bdc1() {
  return logError(function (arg0) {
    console.info(getObject(arg0))
  }, arguments)
}

export function __wbg_log_3445347661d4505e() {
  return logError(function (arg0) {
    console.log(getObject(arg0))
  }, arguments)
}

export function __wbg_warn_5ec7c7c02d0b3841() {
  return logError(function (arg0) {
    console.warn(getObject(arg0))
  }, arguments)
}

export function __wbg_fetch_b4e81012e07ff95a() {
...
export function __wbg_instanceof_Response_e1b11afbefa5b563() {
  return logError(function (arg0) {
...
export function __wbg_url_50e0bdb6051741be() {
  return logError(function (arg0, arg1) {
...
export function __wbg_status_6d8bb444ddc5a7b2() {
  return logError(function (arg0) {
...
export function __wbg_headers_5ffa990806e04cfc() {
  return logError(function (arg0) {
...
export function __wbg_error_09919627ac0992f5() {
  return logError(function (arg0, arg1) {
    try {
...
export function __wbg_stack_0ddaca5d1abfb52f() {
  return logError(function (arg0, arg1) {
...
export function __wbg_newwithlength_75ee2b96c288e6bc() {
  return logError(function (arg0) {
...
export function __wbg_set_1820441f7fb79aad() {
  return logError(function (arg0, arg1, arg2) {
    getObject(arg0)[arg1 >>> 0] = takeObject(arg2)
  }, arguments)
}

export function __wbg_isArray_eb7ad55f2da67dde() {
  return logError(function (arg0) {
...
export function __wbg_push_284486ca27c6aa8b() {
  return logError(function (arg0, arg1) {
...
export function __wbg_values_364ae56c608e6824() {
  return logError(function (arg0) {
...
export function __wbg_newnoargs_be86524d73f67598() {
  return logError(function (arg0, arg1) {
...
export function __wbg_next_c4151d46d5fa7097() {
  return logError(function (arg0) {
    var ret = getObject(arg0).next
    return addHeapObject(ret)
  }, arguments)
...
export function __wbg_done_b06cf0578e89ff68() {
  return logError(function (arg0) {
...
export function __wbg_value_e74a542443d92451() {
  return logError(function (arg0) {
...
export function __wbg_new_b1d61b5687f5e73a() {
  return logError(function (arg0, arg1) {
    try {
...
export function __wbg_resolve_d23068002f584f22() {
  return logError(function (arg0) {
...
export function __wbg_then_2fcac196782070cc() {
  return logError(function (arg0, arg1) {
...
export function __wbg_then_8c2d62e8ae5978f7() {
  return logError(function (arg0, arg1, arg2) {
...
export function __wbg_instanceof_Uint8Array_08a1f3a179095e76() {
  return logError(function (arg0) {
...
export function __wbg_new_a7ce447f15ff496f() {
  return logError(function (arg0) {
...
export function __wbg_length_1eb8fc608a0d4cdb() {
  return logError(function (arg0) {
...
export function __wbg_set_969ad0a60e51d320() {
  return logError(function (arg0, arg1, arg2) {
...
export function __wbg_has_1275b5eec3dc7a7a() {
  return handleError(function (arg0, arg1) {
...
export function __wbg_buffer_397eaa4d72ee94dd() {
  return logError(function (arg0) {
...
export function __wbg_stringify_d4507a59932eed0c() {
  return handleError(function (arg0) {
...
export function __wbindgen_closure_wrapper2790() {
  return logError(function (arg0, arg1, arg2) {
    var ret = makeMutClosure(arg0, arg1, 281, __wbg_adapter_32)
    return addHeapObject(ret)
  }, arguments)
}
