...
*/
export function isIdUniqueWasm(auction_id) {
    var ptr0 = passStringToWasm0(auction_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.isIdUniqueWasm(ptr0, len0);
    return takeObject(ret);
}
...
* @returns {string}
*/
export function getNetWasm() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.getNetWasm(retptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
export function __wbindgen_closure_wrapper4428() { return logError(function (arg0, arg1, arg2) {
