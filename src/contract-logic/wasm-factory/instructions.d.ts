 ...
 * @returns {Uint8Array}
 */
export function getAuctionBankPubkeyWasm(
 ...
 * @returns {Uint8Array}
 */
export function getRootStatePubkeyWasm(
  auction_id: Uint8Array,
  owner_pubkey: Uint8Array
): Uint8Array
/**
...
export function getCycleStatePubkeyWasm(
  root_state_pubkey: Uint8Array,
  cycle_number_bytes: Uint8Array
): Uint8Array
/**
 * @param {Uint8Array} auction_id
 * @param {Uint8Array} owner_pubkey
 * @returns {Uint8Array}
 */
export function getMasterMintPubkeyWasm(
  auction_id: Uint8Array,
  owner_pubkey: Uint8Array
): Uint8Array
/**
