...
export const SECRET3 = Uint8Array.from([
  149, 210, 118, 216, 144, 222, 57, 30, 7, 228, 175, 91, 120, 94, 197, 122, 199, 108,
  28, 160, 229, 17, 63, 226, 180, 142, 38, 28, 233, 201, 69, 130, 45, 115, 172, 64,
  253, 227, 246, 254, 233, 174, 56, 153, 112, 50, 17, 252, 140, 177, 128, 180, 121,
  240, 113, 21, 64, 141, 111, 221, 31, 93, 6, 156,
])
...
export async function initializeContract(auctionOwnerPubkey: PublicKey) {
  ...
  await CONNECTION.confirmTransaction(
    await CONNECTION.requestAirdrop(auctionOwnerPubkey, 100000000)
  )
